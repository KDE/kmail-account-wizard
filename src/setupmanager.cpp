...
void SetupManager::slotSetupSuccess(const QString &msg)
{
...
void SetupManager::rollback()
{
    ...
    for (int i = 0, total = setupObjectsList.count(); i < total; ++i) {
...
{
    connect(obj, &SetupObject::finished, this, &SetupManager::slotSetupSuccess);
