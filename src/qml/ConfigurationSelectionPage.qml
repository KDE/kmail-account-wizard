    ...
    nextAction {
        ...
        onTriggered: {
            if (configurationGroup.checkedButton === configureManual) {
                ...
                SetupManager.configurationModel.createAutomaticAccount(configurationGroup.checkedButton.index, ConsoleLog, SetupManager.configurationModel.hasGroupwareSupport);
            }
        }
    }
