...
#include <QObject>
class ServerTest;
class LIBACCOUNTWIZARD_EXPORT AccountConfigurationBase : public QObject
{
    Q_OBJECT
...
public:
    explicit AccountConfigurationBase(QObject *parent = nullptr);
    ~AccountConfigurationBase() override;
